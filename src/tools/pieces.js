...
let kingW = {color:'w',letter:'k',movement:['king'],limit:true,start:true}
...
let knightB = {color:'b',letter:'n',movement:['jumps']}
...
let kingB = {color:'b',letter:'k',movement:['king'],limit:true}
let pawnB = {color:'b',letter:'p',movement:['forward'],attack:'diagonally',limit:true}
